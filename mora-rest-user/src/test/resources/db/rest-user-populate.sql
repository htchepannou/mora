...
insert into t_user(id, username, email, firstname, lastname, deleted, creation_date, last_update) values(3, 'john.doe', 'john.doe@gmail.com', 'John', 'Dow', 0, '2014-01-01 10:30:55', '2014-12-01 14:30:55');
