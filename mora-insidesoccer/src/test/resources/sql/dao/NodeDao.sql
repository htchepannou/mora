...
insert into nprel(nprel_id, nprel_node_fk, nprel_party_fk, nprel_type_fk) values(100, 100, 100, 1);
...
insert into nprel(nprel_id, nprel_node_fk, nprel_party_fk, nprel_type_fk) values(300, 300, 300, 1);
