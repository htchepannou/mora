...
insert into pattr(pattr_id, pattr_party_fk, pattr_name, pattr_value) values(102, 100, 'logo_url', '/logo.png');
...
insert into pattr(pattr_id, pattr_party_fk, pattr_name, pattr_value) values(502, 500, 'logo_url', '/logo.png');
