...
insert into node(node_id, node_channel_fk, node_owner_fk, node_type_fk, node_deleted, node_date) values(300, 300, 300, 4, 0, now());
insert into nprel(nprel_id, nprel_type_fk, nprel_node_fk, nprel_party_fk) values(301, 4, 300, 320);

insert into node(node_id, node_channel_fk, node_owner_fk, node_type_fk, node_deleted, node_date) values(310, 300, 300, 4, 0, now());
insert into nprel(nprel_id, nprel_type_fk, nprel_node_fk, nprel_party_fk) values(311, 4, 310, 310);

insert into node(node_id, node_channel_fk, node_owner_fk, node_type_fk, node_deleted, node_date) values(320, 300, 300, 4, 1, now());
