-- testFindByNodePartyRelationshipByNames / testFindByNodeByNames
...
-- testFindByNodePartyRelationshipsByNames_deletedNode
...
insert into nprel(nprel_id, nprel_node_fk, nprel_party_fk, nprel_type_fk) values(201, 200, 200, 1);
