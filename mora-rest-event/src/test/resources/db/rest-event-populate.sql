...
insert into t_event(id, user_id, space_id, type_id, deleted, title, start_datetime, end_datetime, creation_date, last_update) values(300, 300, 300, 1, 0, 'title1', now(), now(), '2014-01-01 10:30:55', '2014-12-01 14:30:55');
