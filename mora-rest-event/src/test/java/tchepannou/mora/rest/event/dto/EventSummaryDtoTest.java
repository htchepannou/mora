...
public class EventSummaryDtoTest {
    ...
    public void testBuilder (){
        ...
        assertThat(result.getUser(), equalTo(new UserSummaryDto(user.getId(), user.getFirstName() + " " + user.getLastName())));
        assertThat(result.getSpace(), equalTo(new SpaceSummaryDto(space.getId(), space.getName(), space.getLogoUrl())));
