...
-- getPost
insert into t_media(id, user_id, space_id, type_id, deleted, oembed, size, title, description, content_type, url, thumbnail_url, image_url, creation_date, last_update) values(310, 300, 300, 1, 0, 0, 1024, 'title1', 'description1', 'image/png', 'http://t.com/foo1.png', 'http://t.com/foo_small1.png', 'http://t.com/foo_large1.png', '2014-01-01 10:30:55', '2014-12-01 14:30:55');
insert into t_media(id, user_id, space_id, type_id, deleted, oembed, size, title, description, content_type, url, thumbnail_url, image_url, creation_date, last_update) values(311, 300, 300, 1, 0, 0, 2048, 'title2', 'description2', 'image/png', 'http://t.com/foo2.png', 'http://t.com/foo_small2.png', 'http://t.com/foo_large2.png', '2014-01-01 10:30:55', '2014-12-01 14:30:55');
