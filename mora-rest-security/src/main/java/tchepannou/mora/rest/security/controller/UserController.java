...
public class UserController {
    ...
    public UserDto create (@Valid @RequestBody
                               CreateUserDto request) throws UserException{
        /* Create the user */
        User user = new User ();
        request.toUser(user);
    ...
    public UserDto update (@PathVariable long userId, @Valid @RequestBody
    SaveUserDto request) throws UserException {
        User user = userService.findById(userId);
        if (user == null) {
            throw new UserNotFoundException("User not found: " + userId);
        }
